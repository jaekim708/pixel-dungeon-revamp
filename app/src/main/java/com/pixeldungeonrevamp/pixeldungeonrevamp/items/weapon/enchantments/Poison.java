...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, com.pixeldungeonrevamp.pixeldungeonrevamp.actors.buffs.Poison.class ).
				set( com.pixeldungeonrevamp.pixeldungeonrevamp.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );

 ...
 */
package com.jamjar.pixeldungeonrevamp.actors;
...
import com.jamjar.pixeldungeonrevamp.actors.buffs.EarthImbue;
import com.jamjar.pixeldungeonrevamp.actors.buffs.FireImbue;
...
import com.jamjar.pixeldungeonrevamp.actors.buffs.Speed;
	...
	public boolean attack( Char enemy ) {
		...
		if (hit( this, enemy, false )) {
			...
			int dr = this instanceof Hero && ((Hero)this).rangedWeapon != null &&
					((Hero)this).subClass == HeroSubClass.SNIPER ? 0 : Random.IntRange( 0, enemy.dr() );
			
			int dmg = damageRoll();
			int effectiveDamage = Math.max( dmg - dr, 0 );

			if (this instanceof Hero && ((Hero)this).rangedWeapon != null &&
					Level.distance( pos, enemy.pos ) == 1) {
				effectiveDamage /= 2;
			}

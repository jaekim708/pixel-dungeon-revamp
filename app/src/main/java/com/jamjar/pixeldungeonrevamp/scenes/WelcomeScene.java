...
import com.jamjar.pixeldungeonrevamp.Rankings;
...
public class WelcomeScene extends PixelScene {
	...
	public void create() {
		...
		final int previousVersion = PixelDungeonRevamp.version();

		if (PixelDungeonRevamp.versionCode == previousVersion) {
		...
		float height = title.height +
				(PixelDungeonRevamp.landscape() ? 48 : 96);
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				PixelDungeonRevamp.switchScene(TitleScene.class);
			}
		};
		...
		if (previousVersion != 0){
			DarkRedButton changes = new DarkRedButton(Messages.get(this, "changelist")){
				...
				protected void onClick() {
					super.onClick();
					updateVersion(previousVersion);
					PixelDungeonRevamp.switchScene(ChangesScene.class);
				}
			};
		...
		} else if (previousVersion <= PixelDungeonRevamp.versionCode) {
	...
	private void updateVersion(int previousVersion){
		...
		PixelDungeonRevamp.version(PixelDungeonRevamp.versionCode);
	}

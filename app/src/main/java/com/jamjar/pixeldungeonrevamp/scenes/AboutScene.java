...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		final float colWidth = Camera.main.width / (PixelDungeonRevamp.landscape() ? 2 : 1);
		final float colTop = (Camera.main.height / 2) - (PixelDungeonRevamp.landscape() ? 30 : 90);
		final float wataOffset = PixelDungeonRevamp.landscape() ? colWidth : 0;
		...
		wata.y = PixelDungeonRevamp.landscape() ?
						colTop:

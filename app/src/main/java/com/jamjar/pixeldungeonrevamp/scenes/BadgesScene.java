...
import com.jamjar.pixeldungeonrevamp.effects.BadgeBanner;
...
import com.jamjar.pixeldungeonrevamp.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		float pw = Math.min( w, (PixelDungeonRevamp.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3 ) - 16;
		float ph = Math.min( h, (PixelDungeonRevamp.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3 ) - 32;

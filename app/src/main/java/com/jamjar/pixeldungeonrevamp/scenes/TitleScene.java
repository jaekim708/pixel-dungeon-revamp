...
import com.jamjar.pixeldungeonrevamp.effects.Fireball;
import com.jamjar.pixeldungeonrevamp.messages.Messages;
import com.jamjar.pixeldungeonrevamp.ui.Archs;
import com.jamjar.pixeldungeonrevamp.ui.ChangesButton;
import com.jamjar.pixeldungeonrevamp.ui.ExitButton;
import com.jamjar.pixeldungeonrevamp.ui.LanguageButton;
import com.jamjar.pixeldungeonrevamp.ui.PrefsButton;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		float height = title.height +
				(PixelDungeonRevamp.landscape() ? DashboardItem.SIZE : DashboardItem.SIZE * 2);
		...
		DashboardItem btnBadges = new DashboardItem( Messages.get(this, "badges"), 3 ) {
			...
			protected void onClick() {
				PixelDungeonRevamp.switchNoFade( BadgesScene.class );
			}
		};
		add(btnBadges);
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() {
				PixelDungeonRevamp.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				PixelDungeonRevamp.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );

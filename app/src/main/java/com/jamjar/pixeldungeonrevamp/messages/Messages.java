 ...
 */
package com.jamjar.pixeldungeonrevamp.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.jamjar.pixeldungeonrevamp.messages.actors.actors",
			"com.jamjar.pixeldungeonrevamp.messages.items.items",
			"com.jamjar.pixeldungeonrevamp.messages.levels.levels",
			"com.jamjar.pixeldungeonrevamp.messages.plants.plants",
			"com.jamjar.pixeldungeonrevamp.messages.scenes.scenes",
			"com.jamjar.pixeldungeonrevamp.messages.ui.ui",
			"com.jamjar.pixeldungeonrevamp.messages.windows.windows",
			"com.jamjar.pixeldungeonrevamp.messages.misc.misc"
	};

	static{
		setup(PixelDungeonRevamp.language());
	}
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.jamjar.pixeldungeonrevamp.", "");
			key += "." + k;
		} else
			key = k;
